...
import itz_menu.ocr.postprocessing as postprocessing
...
class TestPostprocessing:
    ...
    def test_dataframe_to_week_menu_validity_period(self, week_menu: pd.DataFrame, init_database):
        ...
        menu = postprocessing.dataframe_to_week_menu(week_menu, validity_period, 'checksum.jpg')
    ...
    def test_dataframe_to_week_menu_filename(self, week_menu: pd.DataFrame, init_database):
        ...
        menu = postprocessing.dataframe_to_week_menu(week_menu, (0, 1), filename)
